import { lorem75, teamDetails, teamDetailsType } from "@/lib/data";
...
const Card = ({ name, url, des }: teamDetailsType) => {
  return (
    <div className="md:flex bg-[#E8F4FD] rounded-lg py-4 md:px-8 my-6">
      ...
      <div className="flex justify-center items-center px-4 ml-4 text-[#0F1629] text-[16px] font-normal">
